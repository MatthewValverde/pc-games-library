...
import { drawFullscreenQuad } from 'playcanvas';
...
pc['extend'](pc, function () {
    ...
    var BloomEffect = function (graphicsDevice) {
        ...
        for (var i = 0; i < 2; i++) {
            ...
            var target = new pc.RenderTarget({colorBuffer,  depth: false });
    ...
    pc.inherits(BloomEffect, pc.PostEffect);
    ...
    BloomEffect.prototype = pc['extend'](BloomEffect.prototype, {
        render: function (inputTarget, outputTarget, rect) {
            ...
            pc.drawFullscreenQuad(device, this.targets[0], this.vertexBuffer, this.extractShader, rect);
            ...
            pc.drawFullscreenQuad(device, this.targets[0], this.vertexBuffer, this.blurShader, rect);
...
//--------------- SCRIPT DEFINITION------------------------//
class Bloom extends ScriptType {
